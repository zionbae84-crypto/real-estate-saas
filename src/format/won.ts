 ...
 *
 * 사용자가 "반올림해서 만원단위로 보여줘"라고 지시한 큰 숫자 자리에
 * 쓴다 — 단지 상세(`ComplexDetail`)의 "취득시 부대비용"·"매달 나가는
 * 돈", "매달 나가는 돈" 계산기(`LoanCalculator`)의 결과, 예산 상세
 * 패널의 "대출 한도" 요약(`BindingExplainer`)이 그 예다.
 *
 ...
 * 안 되는 자리다. 반올림은 **읽기 쉬우라고 큰 숫자에만** 건다.
 *
